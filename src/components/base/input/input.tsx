    ...
    return (
        <AriaGroup
            ...
            className={({ isFocusWithin, isDisabled, isInvalid }) =>
                cx(
                    "group/input relative flex w-full flex-row place-content-center place-items-center rounded-[8px] bg-primary shadow-xs ring-1 ring-primary transition-shadow duration-100 ease-linear ring-inset",
        ...
        >
            ...
            <AriaInput
                ...
                className={cx(
                    "m-0 w-full bg-transparent text-primary ring-0 outline-hidden placeholder:text-placeholder autofill:rounded-[8px] autofill:text-primary disabled:cursor-not-allowed",
