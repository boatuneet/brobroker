...
const withPillTypes = {
    ...
    [badgeTypes.badgeColor]: {
        common: "size-max flex items-center whitespace-nowrap rounded-[8px] ring-1 ring-inset",
        styles: filledColors,
    },
    [badgeTypes.badgeModern]: {
        common: "size-max flex items-center whitespace-nowrap rounded-[8px] ring-1 ring-inset shadow-xs",
        styles: {
            gray: {
...
const withBadgeTypes = {
    ...
    [badgeTypes.badgeModern]: {
        common: "size-max flex items-center whitespace-nowrap rounded-[8px] ring-1 ring-inset bg-primary text-secondary ring-primary shadow-xs",
...
export const Badge = <T extends BadgeTypes>(props: BadgeProps<T>) => {
    ...
    const badgeSizes = {
        ...
        lg: "py-1 px-2.5 text-sm font-medium rounded-[8px]",
    };
...
export const BadgeWithDot = <T extends BadgeTypes>(props: BadgeWithDotProps<T>) => {
    ...
    const badgeSizes = {
        ...
        lg: "gap-1.5 py-1 px-2.5 text-sm font-medium rounded-[8px]",
    };
...
export const BadgeWithIcon = <T extends BadgeTypes>(props: BadgeWithIconProps<T>) => {
    ...
    const badgeSizes = {
        ...
        lg: {
            trailing: "gap-1 py-1 pl-2.5 pr-2 text-sm font-medium rounded-[8px]",
            leading: "gap-1 py-1 pr-2.5 pl-2 text-sm font-medium rounded-[8px]",
        },
    };
...
export const BadgeWithFlag = <T extends BadgeTypes>(props: BadgeWithFlagProps<T>) => {
    ...
    const badgeSizes = {
        ...
        lg: "gap-1.5 py-1 pl-2 pr-2.5 text-sm font-medium rounded-[8px]",
    };
...
export const BadgeWithButton = <T extends BadgeTypes>(props: BadgeWithButtonProps<T>) => {
    ...
    const badgeSizes = {
        ...
        lg: "gap-0.5 py-1 pl-2.5 pr-1.5 text-sm font-medium rounded-[8px]",
    };
        ...
        <span className={cx(colors.common, sizes[type][size], colors.styles[color].root)}>
            ...
            <button
                ...
                className={cx(
                    ...
                    type === "pill-color" ? "rounded-full" : "rounded-[4px]",
                )}
            >
