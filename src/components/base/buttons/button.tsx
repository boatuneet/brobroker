...
export const styles = sortCx({
    ...
    sizes: {
        xs: {
            root: [
                "gap-1 rounded-[8px] px-2.5 py-1.5 text-sm font-semibold before:rounded-[8px] data-icon-only:p-2",
        ...
        sm: {
            root: [
                "gap-1 rounded-[8px] px-3 py-2 text-sm font-semibold before:rounded-[8px] data-icon-only:p-2",
                "in-data-input-wrapper:px-3.5 in-data-input-wrapper:py-2.5 in-data-input-wrapper:data-icon-only:p-2.5",
            ].join(" "),
            linkRoot: "gap-1 *:data-text:underline-offset-3",
        },
        md: {
            root: [
                "gap-1 rounded-[8px] px-3.5 py-2.5 text-sm font-semibold before:rounded-[8px] data-icon-only:p-2.5",
                "in-data-input-wrapper:gap-1.5 in-data-input-wrapper:px-4 in-data-input-wrapper:text-md in-data-input-wrapper:data-icon-only:p-3",
            ].join(" "),
            linkRoot: "gap-1 *:data-text:underline-offset-4",
        },
        lg: {
            root: "gap-1.5 rounded-[8px] px-4 py-2.5 text-md font-semibold before:rounded-[8px] data-icon-only:p-3",
            linkRoot: "gap-1.5 *:data-text:underline-offset-4",
        },
        xl: {
            root: "gap-1.5 rounded-[8px] px-4.5 py-3 text-md font-semibold before:rounded-[8px] data-icon-only:p-3.5",
            linkRoot: "gap-1.5 *:data-text:underline-offset-4",
        },
    },
