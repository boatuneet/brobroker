...
export const Avatar = ({
    ...
    return (
        <div
            data-avatar
            className={cx(
                "relative inline-flex shrink-0 rounded-[8px]",
        ...
        >
            <div
                className={cx(
                    "relative inline-flex size-full shrink-0 items-center justify-center overflow-hidden rounded-[8px] bg-tertiary outline-[0.5px] -outline-offset-[0.5px] outline-black/16 before:inset-[0.5px]",
                    rounded && "rounded-full",
                    canShowImage &&
                        size !== "xs" &&
