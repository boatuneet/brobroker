    ...
    return (
        ...
        >
            {(state) => (
                <div
                    className={cx(
                        "relative flex items-center rounded-[8px] px-2.5 py-2 outline-focus-ring transition duration-100 ease-linear",
...
const DropdownPopover = (props: DropdownPopoverProps) => {
    return (
        <AriaPopover
            ...
            className={(state) =>
                cx(
                    "w-62 origin-(--trigger-anchor-point) overflow-auto rounded-[8px] bg-primary shadow-lg ring-1 ring-secondary_alt will-change-transform",
                    state.isEntering &&
...
const DropdownDotsButton = (props: AriaButtonProps & RefAttributes<HTMLButtonElement>) => {
    return (
        <AriaButton
            ...
            className={(state) =>
                cx(
                    "cursor-pointer rounded-[8px] text-fg-quaternary outline-focus-ring transition duration-100 ease-linear",
