  ...
  return (
    <div className="mx-auto w-full max-w-[1280px] px-6 py-10 sm:px-10 lg:px-14 lg:py-14">
      <section
        ...
        className="relative overflow-hidden rounded-[28px] border border-white/70 bg-[#edeae3] shadow-[0_24px_70px_rgba(23,23,28,0.08)]"
      >
        <div className="relative aspect-video min-h-[760px] sm:min-h-[720px] lg:min-h-0">
          ...
          />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.1)_0%,rgba(0,0,0,0.18)_46%,rgba(0,0,0,0.34)_100%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.42),transparent_38%)]" />
        </div>

        <div className="absolute inset-0 grid content-between gap-6 p-5 sm:p-7 lg:p-8">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="inline-flex min-h-10 items-center gap-2 rounded-full border border-white/55 bg-white/76 px-3.5 text-[13px] font-medium text-[#003c33] shadow-[0_12px_34px_rgba(23,23,28,0.14)] backdrop-blur-md">
              <SegmentIcon className="h-[18px] w-[18px]" aria-hidden="true" />
              {segmentMeta.label} workspace
            </div>
            <div className="flex flex-wrap items-center gap-2">
              <Link
                className="inline-flex min-h-10 items-center gap-2 rounded-full border border-white/60 bg-white/78 px-4 text-sm font-medium text-[#17171c] shadow-[0_12px_34px_rgba(23,23,28,0.12)] backdrop-blur-md hover:bg-white/90"
                href="/voice-crm"
              >
              ...
              <Link
                className="inline-flex min-h-10 items-center gap-2 rounded-full bg-[#17171c] px-5 text-sm font-medium text-white shadow-[0_12px_34px_rgba(23,23,28,0.18)] hover:bg-[#2a2a32]"
                href="/deal-rooms"
              >
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_560px] lg:items-end">
            <div className="flex max-w-[460px] flex-col items-start">
              <div className="rounded-[24px] border border-white/45 bg-white/58 p-4 text-[#17171c] shadow-[0_18px_55px_rgba(23,23,28,0.14)] backdrop-blur-md sm:p-5">
                <p className="bb-mono-label !text-[#003c33]">{segmentMeta.label} command view</p>
                <h2
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {model.metrics.map((metric, index) => {
                ...
                return (
                  <div
                    className="min-h-[118px] rounded-[24px] border border-white/45 bg-white/54 p-4 text-[#17171c] shadow-[0_18px_55px_rgba(23,23,28,0.16)] backdrop-blur-md sm:p-5"
                    key={metric.label}
                  >
                    <div className="flex items-start justify-between gap-3">
                      <p className="text-sm font-medium text-[#3f3f46]">{metric.label}</p>
                      <MetricIcon className="h-[18px] w-[18px] text-[#9f4f2e]" aria-hidden="true" />
                    </div>
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-2 text-[13px] text-[#3f3f46]">
                      <span className="rounded-full bg-white/55 px-2 py-0.5 font-medium text-[#1f7a46] backdrop-blur">
                        {metric.trend}
                      </span>
      ...
      <div className="mt-12 grid items-start gap-8 xl:grid-cols-[minmax(0,1.6fr)_minmax(360px,1fr)]">
