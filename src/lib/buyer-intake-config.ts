...
const commonIdentityFields: BuyerField[] = [
  ...
  { id: "email", label: "Email", kind: "text", placeholder: "helena@example.com", helper: "Optional. Enables the Send email action on approved drafts." },
  { id: "phone", label: "Phone", kind: "text", placeholder: "+39 555 12 34 56", helper: "Optional. Enables the Send via WhatsApp action; include country code." },
